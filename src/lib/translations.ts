...
export const translations: Record<string, any> = {
  bs: {
    ...
    meals: {
      ...
      meals: 'Obroci',
      plan: 'Jelovnik',
      addFood: 'Nova namirnica',
      addMeal: 'Novi obrok',
      addPlan: 'Novi jelovnik',
      newFood: 'Informacije o namirnici',
      foodName: 'Naziv (npr. Raženi hljeb)',
      giValue: 'GI Vrijednost',
      low: 'Nizak GI',
      medium: 'Srednji GI',
      high: 'Visok GI',
      createMeal: 'Kreiraj Obrok',
      createPlan: 'Kreiraj Jelovnik',
      mealName: 'Naziv obroka (npr. Proteinski doručak)',
      planName: 'Naziv jelovnika (npr. Jelovnik 1)',
      selectFoods: 'Odaberite namirnice za obrok',
      selectMeals: 'Odaberite obroke za jelovnik',
      assignToDay: 'Dodaj u dan'
    },
    profile: {
  ...
  de: {
    ...
    meals: {
      ...
      database: 'Lebensmitteldatenbank',
      plan: 'Wochenplan',
      addFood: 'Neues Lebensmittel',
      newFood: 'Neues Lebensmittel',
      foodName: 'Name (z.B. Roggenbrot)',
      giValue: 'GI-Wert',
      low: 'Niedriger Index',
      medium: 'Mittlerer Index',
      high: 'Hoher Index'
    },
    profile: {
  ...
  tr: {
    ...
    meals: {
      ...
      database: 'Gıda Veritabanı',
      plan: 'Haftalık Yemek Planı',
      addFood: 'Yeni gıda ekle',
      newFood: 'Yeni Gıda Maddesi',
      foodName: 'İsim (örn. Çavdar Ekmeği)',
      giValue: 'GI Değeri',
      low: 'Düşük İndeks',
      medium: 'Orta İndeks',
      high: 'Yüksek İndeks'
